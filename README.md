...
2. **Install Visual Studio Code**
  RepMe is a C# application, so you need Visual Studio Code (or Visual Studio) to build and run it.
  Download and install it from:
  https://code.visualstudio.com/

3. **Install .NET SDK**
  Ensure you have the appropriate .NET SDK installed for building the C# application:
  https://dotnet.microsoft.com/download

4. **Open the project in Visual Studio Code**
  Launch VS Code.
  Open the cloned RepMe folder.
  Install the C# extension if prompted (for IntelliSense, debugging, and build support).
